        ...
        <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link href="/signup">
                <Button variant="outlined" size="lg" className="h-12 px-6">
                  Sign up
                </Button>
              </Link>
            </div>
          ...
          <div className="bg-primary rounded-3xl p-8 sm:p-16">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Button variant="outlined" size="lg" className="h-12 px-6 bg-transparent text-primary-foreground border-primary-foreground hover:bg-primary-foreground hover:text-primary">
                  View Gallery
                </Button>
              </div>
            </div>
